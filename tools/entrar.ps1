# "Entrar en mirador" (clic derecho del escritorio, lo instala tools/fondo.mjs).
#
...
$puente = Join-Path $raiz 'puente\bin\Release\net10.0-windows\mirador-puente.exe'
if ((Test-Path $puente) -and -not (Get-Process mirador-puente -ErrorAction SilentlyContinue)) {
